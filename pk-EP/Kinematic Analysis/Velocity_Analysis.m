...
function [Bodies,Jacobian,qd] = Velocity_Analysis(Joints,NBodies,Bodies,dofinfo)
...
funCount = 1;
Jacobian=zeros(dofinfo(1).cdof,NBodies*7);
niu=[];
...
% Solve the system of (velocity) equations
qd = Jacobian\Impose_Column(niu);
