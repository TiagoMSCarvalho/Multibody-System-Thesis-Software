...
function [Bodies,Points,debugdata] = MultiBody_3D_Kinematic_Analysis(NBodies,Bodies,Joints,Points,t,nIteration, opts,debugdata)
    ...
    [Bodies,Jacobian,qd] = Velocity_Analysis(Joints,NBodies,Bodies,debugdata);
