function [Bodies,Points,CoM,DynAcc,it] = MBS_DynAnalysis(NBodies,Bodies,Joints,Forces,Points,CoM,t,TimeStep,Grav,SimType,it)
%Calls the functions needed to solve the Foward Dynamic Problem
    ...
    [DynAcc,~,Jacobian,Bodies] = DynInitialAccel(NBodies,Bodies,Joints,Forces,Grav,SimType);
